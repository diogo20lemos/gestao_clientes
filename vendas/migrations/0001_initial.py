...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('clientes', '0013_auto_20200309_1058'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('setar_nfe', 'Usuario pode alterar o parametro NF-e'), ('ver_dashboard', 'Pode visualizar o Dashboard'), ('permissao3', 'Permissao 3')),
            },
        ),
        migrations.AddField(
